...
const Services = () => {
  return (
    <>
      ...
      <PageBanner
        title="Our Services"
        desc="At AI Company, we are not just committed to driving growth; we also cultivate a culture of continuous learning and innovation within our team. Our passionate engineers and data scientists are encouraged to explore new ideas, push boundaries, and embrace the latest advancements in AI technology."
      />
      <AllServices />
      <OurValue />
      <WhyChooseUs />
