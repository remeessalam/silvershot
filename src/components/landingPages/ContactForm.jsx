...
const ContactForm = () => {
  ...
  return (
    <div
      id="contact"
      className="py-[5rem] bg-cover bg-[100%_40%] relative grayscale min-h-[40rem] flex items-center"
        ...
        >
          <div className="flex flex-col gap-1">
            <input
              type="text"
              placeholder="Name"
              className="outline-none border-white border bg-transparent p-2 rounded-sm shadow-large shadow-primary/30"
              {...register("name", {
            ...
            />
            <small className="error-message !text-red-500">
              {errors.name?.message}
            </small>
          </div>
          <div className="flex flex-col gap-1">
