  ...
  return (
    <section className=" py-[5rem]">
      <div className="wrapper grid md:grid-cols-2 items-center gap-7">
        ...
        <div
          data-aos="fade-up"
          className="bg-darkbg flex flex-col gap-6 h-full justify-center rounded-xl p-10"
        >
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
              <p className="font-medium">AI calling agency</p>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
              <p className="font-medium">Cloud Computing services</p>
