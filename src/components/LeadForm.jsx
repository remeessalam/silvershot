...
const LeadForm = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col gap-5 py-[5rem]"
    >
      <h2 className="heading-2 text-center">Connect With Us Today!</h2>
      <p className="desc text-center max-w-[55rem] mx-auto">
      ...
      <form
        ...
        className="flex flex-col w-full gap-4 rounded-xl p-5 bg-darkbg max-w-3xl mx-auto mt-5"
      >
        <div className="grid sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1">
            ...
            <input
              type="text"
              className="outline-none p-2  bg-white/60 text-secondary placeholder-gray-500"
              placeholder="Name"
              {...register("name", {
